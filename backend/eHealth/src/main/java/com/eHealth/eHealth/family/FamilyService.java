...
public class FamilyService {
    ...
    @Transactional
    public Family addMember(HttpServletRequest request, AddFamilyMemberRequest req) {
        String token = JwtUtil.extractToken(request);
        Patient owner = resolvePatient(token);
    ...
    @Transactional
    public void removeMember(HttpServletRequest request, String patientId) {
        String token = JwtUtil.extractToken(request);
        Patient owner = resolvePatient(token);
    ...
    @Transactional
    public List<FamilyMemberResponse> getFamilyMembers(HttpServletRequest request) {
        String token = JwtUtil.extractToken(request);
