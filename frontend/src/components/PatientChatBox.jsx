...
export default function PatientChatBox({ user, patient, doctor }) {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <strong>Chat with Doctor</strong>
        ...
        {messages.map((m, i) => (
          <div
            ...
            style={{
              ...styles.message,
              alignSelf:
                m.senderRole === "PATIENT" ? "flex-end" : "flex-start",
              backgroundColor:
                m.senderRole === "PATIENT" ? "#d1e7ff" : "#f1f1f1",
            }}
          >
